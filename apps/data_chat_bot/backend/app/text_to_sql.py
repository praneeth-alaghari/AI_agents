...
from app.database import get_table_schema, get_date_range, execute_raw_sql
...
def nl_to_sql(question: str, db_name: str, table_name: str) -> str:
    ...
    Returns either a raw SQL string or ``"NO_SQL: <response>"`` for
    greetings / non-data questions.
    """
...
def run_query(sql: str, db_name: str) -> dict | str:
    """Execute a generated SQL query and return results (or a conversational reply)."""
